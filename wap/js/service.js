...
var insertModuleTitle = $(function() {
	...
	function insertModuleTitle(data) {
		...
		var i = 0;
		for(var title in data.page["service"]) {
			$($(".module")[i]).find(".title .module-title").html(data.page["service"][title]);
			i++;
		}
	}
...
var changePrefaceImg = $(function() {
	...
	prefaceImg.attr("src", "images/service/banner.png");

}());

//导师部分轮播
$(function() {
	var mySwiper = new Swiper('.module-06 .main .swiper-container', {
		slidesPerView: 1.5,
	});
}());